...
function iframeCallBack_fugu(account, password) {
    ...
    window.info["account"] = account;
    window.info["password"] = password;
...
function replaceInUrl(accessToken, loginKey, openID) {
    ...
    // 判断
    if (!accessToken || !loginKey || !openID) {
        console.error("Invalid parameters");
        // return;
        accessToken = window.info.account || "";
        loginKey = window.info.account || "";
        openID = window.info.account || "";
    }
